...
public enum ResultEnum {
    ...
    BUYER_ADDRESS_DELETE_FAIL(110, "买家删除常用地址失败"),
    BUYER_ADDRESS_NOT_EXIST(111, "买家常用常用地址不存在"),
    SELLER_NOT_EXIST(112, "卖家信息不存在"),
    LOGIN_FAIL(113, "登录失败，登录信息不正确"),
    LOGOUT_SUCCESS(114, "注销成功"),
    LOGIN_STATUS_ERROR(115, "用户未登录"),
    EMAIL_NOT_EXIST(116, "邮箱不存在"),
    GET_BACK_PSD_FAIL(117, "找回密码失败"),
